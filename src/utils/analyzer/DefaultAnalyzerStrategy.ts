...
import { Affinity, AuricularArea, PubicSymphysis, Sex, SternalEnd, ThirdMolar, Report, Side } from "../enums";
...
export class DefaultAnalyzerStrategy extends AbstractAnalyzer {
    ...
    public executeAnalysis(_case : CaseModel): {[key: string]: {[key: string] : number}} {
    ...
    private pubicSymphysis(data : PubicSymphysis, side: Side, isMale: boolean, isUnknown: boolean): void {
        ...
        switch(data) {
            case PubicSymphysis.One:
                this.results[Report.pubicSymphysis][`${side}`] = (isUnknown) ? 
                    this.average(19.29, 19.8) : (isMale) ? 
                        19.29 : 19.8;
                this.results[Report.pubicSymphysis][`${side}_min`] = (isUnknown) ? 
                    this.average(15.43, 17.14) : (isMale) ? 
                        15.43 : 17.14;
                this.results[Report.pubicSymphysis][`${side}_max`] = (isUnknown) ? 
                    this.average(23.15, 22.46) : (isMale) ? 
                        23.15 : 22.46;
                break;
            case PubicSymphysis.Two:
                this.results[Report.pubicSymphysis][`${side}`] = (isUnknown) ? 
                    this.average(22.14, 23.20) : (isMale) ? 
                        22.14 : 23.20;
                this.results[Report.pubicSymphysis][`${side}_min`] = (isUnknown) ? 
                    this.average(18.42, 18.44) : (isMale) ? 
                        18.42 : 18.44;
                this.results[Report.pubicSymphysis][`${side}_max`] = (isUnknown) ? 
                    this.average(25.86, 27.96) : (isMale) ? 
                        25.86 : 27.96;
                break;
            case PubicSymphysis.Three:
                this.results[Report.pubicSymphysis][`${side}`] = (isUnknown) ? 
                    this.average(29.53, 31.44) : (isMale) ? 
                        29.53 : 31.44;
                this.results[Report.pubicSymphysis][`${side}_min`] = (isUnknown) ? 
                    this.average(16.27, 21.20) : (isMale) ? 
                        16.27 : 21.20;
                this.results[Report.pubicSymphysis][`${side}_max`] = (isUnknown) ? 
                    this.average(42.79, 41.68) : (isMale) ? 
                        42.79 : 41.68;
                break;
            case PubicSymphysis.Four:
                this.results[Report.pubicSymphysis][`${side}`] = (isUnknown) ? 
                    this.average(42.54, 43.26) : (isMale) ? 
                        42.54 : 43.26;
                this.results[Report.pubicSymphysis][`${side}_min`] = (isUnknown) ? 
                    this.average(24.94, 31.02) : (isMale) ? 
                        24.94 : 37.36;
                this.results[Report.pubicSymphysis][`${side}_max`] = (isUnknown) ? 
                    this.average(60.14, 55.50) : (isMale) ? 
                        60.14 : 55.50;
                break;
            case PubicSymphysis.Five:
                this.results[Report.pubicSymphysis][`${side}`] = (isUnknown) ? 
                    this.average(53.87, 51.47) : (isMale) ? 
                        53.87 : 51.47;
                this.results[Report.pubicSymphysis][`${side}_min`] = (isUnknown) ? 
                    this.average(37.03, 43.59) : (isMale) ? 
                        37.03 : 43.59;
                this.results[Report.pubicSymphysis][`${side}_max`] = (isUnknown) ? 
                    this.average(70.71, 59.35) : (isMale) ? 
                        70.71 : 59.35;
                break;
            case PubicSymphysis.Six:
                this.results[Report.pubicSymphysis][`${side}`] = (isUnknown) ? 
                    this.average(63.76, 72.34) : (isMale) ? 
                        63.76 : 72.34;
                this.results[Report.pubicSymphysis][`${side}_min`] = (isUnknown) ? 
                    this.average(47.64, 57.62) : (isMale) ? 
                        47.64 : 57.62;
                this.results[Report.pubicSymphysis][`${side}_max`] = (isUnknown) ? 
                    this.average(79.88, 87.06) : (isMale) ? 
                        79.88 : 87.06;
                break;
            case PubicSymphysis.Seven:
                this.results[Report.pubicSymphysis][`${side}`] = (isUnknown) ? 
                    this.average(77.00, 82.54) : (isMale) ? 
                        77.00 : 81.20;
                this.results[Report.pubicSymphysis][`${side}_min`] = (isUnknown) ? 
                    this.average(58.34, 67.72) : (isMale) ? 
                        58.34 : 67.72;
                this.results[Report.pubicSymphysis][`${side}_max`] = (isUnknown) ? 
                    this.average(95.66, 97.36) : (isMale) ? 
                        95.66 : 97.36;
                break;
    ...
    // calculating an average for cases with an unknown sex
    private sternalEnd(data : SternalEnd, side: Side, isMale: boolean, isUnknown: boolean): void {
        ...
        switch(data) {
            case SternalEnd.One:
                this.results[Report.sternalEnd][`${side}`] = (isUnknown) ? 
                    this.average(20.00, 19.57) : (isMale) ? 
                        20.00 : 19.57;
                this.results[Report.sternalEnd][`${side}_min`] = (isUnknown) ? 
                    this.average(17.10, 16.23) : (isMale) ? 
                        17.10 : 16.23;
                this.results[Report.sternalEnd][`${side}_max`] = (isUnknown) ? 
                    this.average(22.90, 22.91) : (isMale) ? 
                        22.90 : 22.91;
                break;
            case SternalEnd.Two:
                this.results[Report.sternalEnd][`${side}`] = (isUnknown) ? 
                    this.average(24.63, 25.14) : (isMale) ? 
                        24.63 : 25.14;
                this.results[Report.sternalEnd][`${side}_min`] = (isUnknown) ? 
                    this.average(20.63, 22.80) : (isMale) ? 
                        20.63 : 22.80;
                this.results[Report.sternalEnd][`${side}_max`] = (isUnknown) ? 
                    this.average(28.63, 27.48) : (isMale) ? 
                        28.63 : 27.48;
                break;
            case SternalEnd.Three:
                this.results[Report.sternalEnd][`${side}`] = (isUnknown) ? 
                    this.average(32.27, 32.95) : (isMale) ? 
                        32.27 : 32.95;
                this.results[Report.sternalEnd][`${side}_min`] = (isUnknown) ? 
                    this.average(24.89, 26.61) : (isMale) ? 
                        24.89 : 26.61;
                this.results[Report.sternalEnd][`${side}_max`] = (isUnknown) ? 
                    this.average(39.65, 39.29) : (isMale) ? 
                        39.65 : 39.29;
                break;
            case SternalEnd.Four:
                this.results[Report.sternalEnd][`${side}`] = (isUnknown) ? 
                    this.average(42.43, 43.52) : (isMale) ? 
                        42.43 : 43.52;
                this.results[Report.sternalEnd][`${side}_min`] = (isUnknown) ? 
                    this.average(36.47, 37.36) : (isMale) ? 
                        36.47 : 37.36;
                this.results[Report.sternalEnd][`${side}_max`] = (isUnknown) ? 
                    this.average(48.39, 49.68) : (isMale) ? 
                        48.39 : 49.68;
                break;
            case SternalEnd.Five:
                this.results[Report.sternalEnd][`${side}`] = (isUnknown) ? 
                    this.average(52.05, 51.69) : (isMale) ? 
                        52.05 : 51.69;
                this.results[Report.sternalEnd][`${side}_min`] = (isUnknown) ? 
                    this.average(45.05, 45.07) : (isMale) ? 
                        45.05 : 45.07;
                this.results[Report.sternalEnd][`${side}_max`] = (isUnknown) ? 
                    this.average(59.05, 58.31) : (isMale) ? 
                        59.05 : 58.31;
                break;
            case SternalEnd.Six:
                this.results[Report.sternalEnd][`${side}`] = (isUnknown) ? 
                    this.average(63.13, 67.17) : (isMale) ? 
                        63.13 : 67.17;
                this.results[Report.sternalEnd][`${side}_min`] = (isUnknown) ? 
                    this.average(56.07, 60.35) : (isMale) ? 
                        56.07 : 60.35;
                this.results[Report.sternalEnd][`${side}_max`] = (isUnknown) ? 
                    this.average(70.19, 73.99) : (isMale) ? 
                        70.19 : 73.99;
                break;
            case SternalEnd.Seven:
                this.results[Report.sternalEnd][`${side}`] = (isUnknown) ? 
                    this.average(80.91, 81.20) : (isMale) ? 
                        80.91 : 81.20;
                this.results[Report.sternalEnd][`${side}_min`] = (isUnknown) ? 
                    this.average(67.71, 67.30) : (isMale) ? 
                        67.71 : 67.30;
                this.results[Report.sternalEnd][`${side}_max`] = (isUnknown) ? 
                    this.average(94.11, 95.10) : (isMale) ? 
                        94.11 : 95.10;
                break;
    ...
    private auricularSurface(data: AuricularArea, side: Side): void {
        ...
        switch(data) {
            ...
            case AuricularArea.Two:
                ...
                this.results[Report.auricularSurface][`${side}_min`] = 13.10;
                this.results[Report.auricularSurface][`${side}_max`] = 45.90;
                break;
            case AuricularArea.Three:
                this.results[Report.auricularSurface][`${side}`] = 42.00;
            ...
            case AuricularArea.Four:
                this.results[Report.auricularSurface][`${side}`] = 47.80;
                this.results[Report.auricularSurface][`${side}_min`] = 19.90;
                this.results[Report.auricularSurface][`${side}_max`] = 75.70;
                break;
            case AuricularArea.Five:
                this.results[Report.auricularSurface][`${side}`] = 53.10;
            ...
            case AuricularArea.Six:
                this.results[Report.auricularSurface][`${side}`] = 58.90;
    ...
    private thirdMolar(data: ThirdMolar, side: Side): void {
        if (side != Side.TL && side != Side.TR && side != Side.BL && side != Side.BR)
    ...
    private average(v1: number, v2: number) : number { return (v1 + v2) / 2.0; }
